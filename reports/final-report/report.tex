...
\begin{figure}[!htb]
    \begin{center}
      \includegraphics[height=9cm, scale=0.01,keepaspectratio]{Hierarchical cluster numbers evaluation.png}
      \caption{Number of variables clustering analysis}
    \end{center}
\end{figure}
...
\begin{figure}[!htb]
    \begin{center}
      \includegraphics[height=9cm, scale=0.01,keepaspectratio]{Dendrogram of variable cluster.png}
      \caption{Number of variables clustering analysis}
    \end{center}
\end{figure}
